...
1. MUST: All HTTP client implementations (base_client, cached_client, registry_client) MUST instrument public methods with tracing spans that capture request context including URL, method, and relevant metadata

## Policy Block

- MUST All HTTP client implementations (base_client, cached_client, registry_client) MUST instrument public methods with tracing spans that capture request context including URL, method, and relevant metadata
