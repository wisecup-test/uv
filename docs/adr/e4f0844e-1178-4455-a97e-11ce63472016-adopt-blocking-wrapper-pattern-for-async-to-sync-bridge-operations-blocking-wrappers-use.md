...
1. MUST: Blocking wrappers MUST use tokio::runtime::Runtime::block_on or equivalent runtime-specific blocking mechanisms to execute async code synchronously

## Policy Block

- MUST Blocking wrappers MUST use tokio::runtime::Runtime::block_on or equivalent runtime-specific blocking mechanisms to execute async code synchronously
