...
1. MUST: Modules that bridge async operations to synchronous APIs MUST implement dedicated blocking wrapper types or functions (e.g., blocking.rs modules)

## Policy Block

- MUST Modules that bridge async operations to synchronous APIs MUST implement dedicated blocking wrapper types or functions (e.g., blocking.rs modules)
