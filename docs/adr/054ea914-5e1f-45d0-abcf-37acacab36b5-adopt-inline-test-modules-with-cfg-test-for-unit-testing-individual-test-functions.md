...
1. MUST: Individual test functions MUST be marked with the #[test] attribute to be recognized by the test harness

## Policy Block

- MUST Individual test functions MUST be marked with the #[test] attribute to be recognized by the test harness
