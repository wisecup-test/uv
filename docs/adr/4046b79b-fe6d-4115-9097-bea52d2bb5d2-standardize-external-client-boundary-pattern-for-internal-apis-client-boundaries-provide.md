...
1. SHOULD: Client boundaries SHOULD provide observability hooks for logging, metrics, and tracing of external interactions

## Policy Block

- SHOULD Client boundaries SHOULD provide observability hooks for logging, metrics, and tracing of external interactions
