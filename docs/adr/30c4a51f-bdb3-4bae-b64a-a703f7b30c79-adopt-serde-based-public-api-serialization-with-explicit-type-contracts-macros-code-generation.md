...
1. SHOULD: Macros or code generation SHOULD be used to ensure consistent serialization patterns across API types

## Policy Block

- SHOULD Macros or code generation SHOULD be used to ensure consistent serialization patterns across API types
