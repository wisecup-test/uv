...
1. SHOULD: Common test utilities and fixtures SHOULD be extracted to shared test modules (e.g., tests/common/mod.rs) when used across multiple test files

## Policy Block

- SHOULD Common test utilities and fixtures SHOULD be extracted to shared test modules (e.g., tests/common/mod.rs) when used across multiple test files
