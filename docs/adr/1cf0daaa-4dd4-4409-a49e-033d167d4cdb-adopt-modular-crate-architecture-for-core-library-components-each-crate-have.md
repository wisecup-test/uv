...
1. MUST: Each crate MUST have a clear, single responsibility that can be described in one sentence

## Policy Block

- MUST Each crate MUST have a clear, single responsibility that can be described in one sentence
