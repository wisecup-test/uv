...
1. MAY: Newtype wrappers MAY implement Deref to the inner type when read-only access patterns are common and safe

## Policy Block

- MAY Newtype wrappers MAY implement Deref to the inner type when read-only access patterns are common and safe
