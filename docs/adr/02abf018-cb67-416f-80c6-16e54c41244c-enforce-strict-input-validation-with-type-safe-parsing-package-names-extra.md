...
1. MUST: Package names, extra names, group names, and identifiers MUST be validated against defined naming rules and character constraints

## Policy Block

- MUST Package names, extra names, group names, and identifiers MUST be validated against defined naming rules and character constraints
