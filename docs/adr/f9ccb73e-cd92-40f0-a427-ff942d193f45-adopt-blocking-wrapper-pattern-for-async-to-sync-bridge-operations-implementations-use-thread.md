...
1. MAY: Implementations MAY use thread-local or lazy-static runtime instances for performance optimization in hot paths

## Policy Block

- MAY Implementations MAY use thread-local or lazy-static runtime instances for performance optimization in hot paths
