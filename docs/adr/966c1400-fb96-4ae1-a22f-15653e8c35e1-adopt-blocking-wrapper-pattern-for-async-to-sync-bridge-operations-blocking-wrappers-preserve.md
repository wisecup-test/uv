...
1. SHOULD: Blocking wrappers SHOULD preserve error types and semantics from the underlying async operations

## Policy Block

- SHOULD Blocking wrappers SHOULD preserve error types and semantics from the underlying async operations
