...
1. MUST: All external input MUST be validated before use, including CLI arguments, HTTP responses, file contents, and user-provided strings

## Policy Block

- MUST All external input MUST be validated before use, including CLI arguments, HTTP responses, file contents, and user-provided strings
