...
1. MUST: Public API types MUST use newtype patterns or dedicated structs rather than exposing raw primitives to enable future evolution

## Policy Block

- MUST Public API types MUST use newtype patterns or dedicated structs rather than exposing raw primitives to enable future evolution
