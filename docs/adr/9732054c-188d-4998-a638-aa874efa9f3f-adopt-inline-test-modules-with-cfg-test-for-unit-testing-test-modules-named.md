...
1. SHOULD: Test modules SHOULD be named 'tests' or follow a descriptive naming convention that clearly indicates their purpose

## Policy Block

- SHOULD Test modules SHOULD be named 'tests' or follow a descriptive naming convention that clearly indicates their purpose
