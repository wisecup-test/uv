...
1. MUST: All public API types MUST implement explicit Serde serialization and deserialization traits (Serialize, Deserialize)

## Policy Block

- MUST All public API types MUST implement explicit Serde serialization and deserialization traits (Serialize, Deserialize)
