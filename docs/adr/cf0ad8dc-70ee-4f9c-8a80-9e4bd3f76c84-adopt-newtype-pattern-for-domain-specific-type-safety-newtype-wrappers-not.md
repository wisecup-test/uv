...
1. MUST_NOT: Newtype wrappers MUST NOT implement automatic conversion traits (From/Into) that bypass validation logic

## Policy Block

- MUST_NOT Newtype wrappers MUST NOT implement automatic conversion traits (From/Into) that bypass validation logic
