...
1. SHOULD: Authentication and proxy-related operations SHOULD include tracing spans with sanitized metadata (excluding credentials) to support security audit and troubleshooting

## Policy Block

- SHOULD Authentication and proxy-related operations SHOULD include tracing spans with sanitized metadata (excluding credentials) to support security audit and troubleshooting
