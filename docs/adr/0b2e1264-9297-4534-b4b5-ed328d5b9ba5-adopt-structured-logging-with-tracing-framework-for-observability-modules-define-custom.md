...
1. MAY: Modules MAY define custom tracing subscribers or layers for specialized observability requirements such as performance profiling or metrics collection

## Policy Block

- MAY Modules MAY define custom tracing subscribers or layers for specialized observability requirements such as performance profiling or metrics collection
