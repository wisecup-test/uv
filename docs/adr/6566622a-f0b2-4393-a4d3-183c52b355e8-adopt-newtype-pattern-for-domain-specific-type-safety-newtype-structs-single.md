...
1. MUST: Newtype structs MUST be single-field tuple structs or single-field named structs with private fields to enforce encapsulation

## Policy Block

- MUST Newtype structs MUST be single-field tuple structs or single-field named structs with private fields to enforce encapsulation
