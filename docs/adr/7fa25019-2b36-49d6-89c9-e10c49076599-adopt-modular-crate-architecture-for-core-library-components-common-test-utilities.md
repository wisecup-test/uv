...
1. SHOULD: Common test utilities SHOULD be placed in a common/mod.rs file within the tests directory

## Policy Block

- SHOULD Common test utilities SHOULD be placed in a common/mod.rs file within the tests directory
