...
1. MUST: Parsed HTML index data and flat index structures MUST be cached to prevent redundant parsing of the same registry responses

## Policy Block

- MUST Parsed HTML index data and flat index structures MUST be cached to prevent redundant parsing of the same registry responses
