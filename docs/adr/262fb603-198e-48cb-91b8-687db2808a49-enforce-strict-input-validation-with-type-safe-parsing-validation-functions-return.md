...
1. SHOULD: Validation functions SHOULD return Result types with descriptive error messages indicating what validation failed and why

## Policy Block

- SHOULD Validation functions SHOULD return Result types with descriptive error messages indicating what validation failed and why
