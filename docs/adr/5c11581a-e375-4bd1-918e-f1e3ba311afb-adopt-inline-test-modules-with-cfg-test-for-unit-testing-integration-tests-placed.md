...
1. MAY: Integration tests MAY be placed in separate files under tests/ directory when testing public API contracts across module boundaries

## Policy Block

- MAY Integration tests MAY be placed in separate files under tests/ directory when testing public API contracts across module boundaries
