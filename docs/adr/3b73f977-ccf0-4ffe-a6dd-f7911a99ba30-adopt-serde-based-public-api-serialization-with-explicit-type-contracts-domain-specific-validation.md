...
1. SHOULD: Domain-specific validation logic SHOULD be encapsulated within the type definition (e.g., PackageName, ExtraName validation)

## Policy Block

- SHOULD Domain-specific validation logic SHOULD be encapsulated within the type definition (e.g., PackageName, ExtraName validation)
