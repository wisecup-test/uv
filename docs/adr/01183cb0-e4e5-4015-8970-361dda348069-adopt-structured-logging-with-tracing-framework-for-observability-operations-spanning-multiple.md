...
1. MUST: Operations spanning multiple function calls or async boundaries MUST be instrumented with tracing spans using #[instrument] or span! macros to provide hierarchical context

## Policy Block

- MUST Operations spanning multiple function calls or async boundaries MUST be instrumented with tracing spans using #[instrument] or span! macros to provide hierarchical context
