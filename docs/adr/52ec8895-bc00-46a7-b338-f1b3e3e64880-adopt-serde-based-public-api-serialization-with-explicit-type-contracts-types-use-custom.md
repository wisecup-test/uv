...
1. MAY: API types MAY use custom Serde attributes (rename, skip, flatten) to optimize wire format while maintaining type safety

## Policy Block

- MAY API types MAY use custom Serde attributes (rename, skip, flatten) to optimize wire format while maintaining type safety
