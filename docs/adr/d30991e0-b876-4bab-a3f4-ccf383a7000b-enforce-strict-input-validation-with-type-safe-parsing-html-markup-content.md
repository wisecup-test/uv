...
1. MUST: HTML and markup content MUST be parsed with dedicated parsers that handle malformed input safely

## Policy Block

- MUST HTML and markup content MUST be parsed with dedicated parsers that handle malformed input safely
