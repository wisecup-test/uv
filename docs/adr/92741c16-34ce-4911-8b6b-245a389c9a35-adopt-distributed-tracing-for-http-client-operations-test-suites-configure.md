...
1. MAY: Test suites MAY configure tracing subscribers to validate instrumentation coverage and verify span structure in integration tests

## Policy Block

- MAY Test suites MAY configure tracing subscribers to validate instrumentation coverage and verify span structure in integration tests
