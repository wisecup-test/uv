...
1. SHOULD: Logging statements SHOULD include structured fields using the field=value syntax to enable filtering, aggregation, and analysis

## Policy Block

- SHOULD Logging statements SHOULD include structured fields using the field=value syntax to enable filtering, aggregation, and analysis
