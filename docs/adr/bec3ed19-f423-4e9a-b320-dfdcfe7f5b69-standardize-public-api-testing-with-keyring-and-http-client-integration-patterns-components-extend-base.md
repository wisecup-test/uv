...
1. MAY: Components MAY extend the base HTTP client with additional caching strategies specific to their use case

## Policy Block

- MAY Components MAY extend the base HTTP client with additional caching strategies specific to their use case
