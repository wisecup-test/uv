...
1. MUST: Crate names MUST follow the pattern 'uv-{domain}' where domain describes the functional area

## Policy Block

- MUST Crate names MUST follow the pattern 'uv-{domain}' where domain describes the functional area
