...
1. SHOULD: Modules providing both async and sync APIs SHOULD separate concerns into distinct files (e.g., lib.rs for async, blocking.rs for sync wrappers)

## Policy Block

- SHOULD Modules providing both async and sync APIs SHOULD separate concerns into distinct files (e.g., lib.rs for async, blocking.rs for sync wrappers)
