...
1. SHOULD: Cache hit/miss decisions in cached_client SHOULD be recorded as span attributes to enable cache effectiveness analysis

## Policy Block

- SHOULD Cache hit/miss decisions in cached_client SHOULD be recorded as span attributes to enable cache effectiveness analysis
