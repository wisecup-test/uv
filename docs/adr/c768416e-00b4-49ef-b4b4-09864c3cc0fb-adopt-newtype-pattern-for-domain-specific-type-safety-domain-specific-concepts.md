...
1. MUST: Domain-specific concepts with validation rules or semantic meaning MUST be represented as newtype wrappers around primitive types rather than using primitives directly

## Policy Block

- MUST Domain-specific concepts with validation rules or semantic meaning MUST be represented as newtype wrappers around primitive types rather than using primitives directly
