# Adopt In-Memory Caching Layer for Package Metadata and HTTP Responses: Site Packages Metadata
...
1. MUST: Site-packages metadata and installed package information MUST be cached to avoid repeated filesystem scans during dependency resolution

## Policy Block

- MUST Site-packages metadata and installed package information MUST be cached to avoid repeated filesystem scans during dependency resolution
