...
1. MUST: External client boundaries MUST be designed to support testing through dependency injection or trait abstraction

## Policy Block

- MUST External client boundaries MUST be designed to support testing through dependency injection or trait abstraction
