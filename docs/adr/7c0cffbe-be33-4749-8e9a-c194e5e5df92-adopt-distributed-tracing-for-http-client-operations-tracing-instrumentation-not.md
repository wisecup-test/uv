...
1. MUST_NOT: Tracing instrumentation MUST NOT log sensitive data including authentication tokens, passwords, or API keys in span attributes or events

## Policy Block

- MUST_NOT Tracing instrumentation MUST NOT log sensitive data including authentication tokens, passwords, or API keys in span attributes or events
