...
1. MAY: Crates MAY be published independently to crates.io if they provide reusable functionality beyond the project

## Policy Block

- MAY Crates MAY be published independently to crates.io if they provide reusable functionality beyond the project
