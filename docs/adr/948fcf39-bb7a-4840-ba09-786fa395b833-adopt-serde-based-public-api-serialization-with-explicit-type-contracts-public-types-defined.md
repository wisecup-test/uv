...
1. SHOULD: Public API types SHOULD be defined in dedicated modules (e.g., uv-normalize, uv-cli) separate from internal implementation

## Policy Block

- SHOULD Public API types SHOULD be defined in dedicated modules (e.g., uv-normalize, uv-cli) separate from internal implementation
