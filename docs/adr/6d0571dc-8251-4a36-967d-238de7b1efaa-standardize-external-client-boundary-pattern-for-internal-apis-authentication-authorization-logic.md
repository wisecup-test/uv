# Standardize External Client Boundary Pattern for Internal APIs: Authentication Authorization Logic
...
1. SHOULD: Authentication and authorization logic SHOULD be encapsulated within the client boundary layer rather than scattered across calling code

## Policy Block

- SHOULD Authentication and authorization logic SHOULD be encapsulated within the client boundary layer rather than scattered across calling code
