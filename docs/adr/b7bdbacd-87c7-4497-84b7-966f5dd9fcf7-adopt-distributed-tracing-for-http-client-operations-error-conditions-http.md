...
1. MUST: Error conditions in HTTP operations MUST be recorded as span events or error attributes to enable failure analysis and alerting

## Policy Block

- MUST Error conditions in HTTP operations MUST be recorded as span events or error attributes to enable failure analysis and alerting
