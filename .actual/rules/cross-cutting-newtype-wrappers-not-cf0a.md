# Adopt Newtype Pattern for Domain-Specific Type Safety: Newtype Wrappers Not
...
- **R-NEWTYPE-001** MUST NOT: Newtype wrappers MUST NOT implement automatic conversion traits (From/Into) that bypass validation logic.
...
# Check for type alias usage in domain model
...
- No automatic conversion traits (From/Into) bypass validation logic in newtype implementations
