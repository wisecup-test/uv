...
- **R-AUTH-001** SHOULD: Authentication and authorization logic SHOULD be encapsulated within the client boundary layer rather than scattered across calling code.
